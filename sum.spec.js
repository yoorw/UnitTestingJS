...
describe('sum suite', function() {
    test('Should add 2 positive numbers together and return the reuslt', function() {
        expect(sum(1,2)).toBe(3);
    });

    test('Should add 2 negative numbers together and return the reuslt', function() {
        expect(sum(-1,-2)).toBe(-3);
    });

    test('Should add 1 positive and 1 negative number together and return the reuslt', function() {
